...
from scheduler import build_scheduler, check_event_changes, check_new_invitations  # run_daily_briefing: DESACTIVADO 2026-06-12
...
async def lifespan(app: FastAPI):
    ...
    async def _invitations_job():
        ...
        await check_event_changes(tg_app)
